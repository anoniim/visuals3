...
fun main() {
    ...
    PApplet.main(arrayOf(TestSketch::class.qualifiedName))
...
// Reward / Return from the special world
//    PApplet.main(arrayOf(RaisingTiles::class.qualifiedName))


// The end - cyclic or a symbol
